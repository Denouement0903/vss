  ...
  return (
    ...
    <div className="flex flex-col">
      <div className="flex-1">
        <section className="w-full py-36 dark:bg-gray-800 hero h-[35rem]">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col space-y-4 drop-shadow-lg">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-white">Welcome  to VSS | Welkom by VSS</h1>
